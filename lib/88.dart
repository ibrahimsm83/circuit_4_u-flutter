...
class eighty8 extends StatelessWidget {
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/18-0HINppcrMy4VrnXGOM1FVXfjIVc3CU/view?usp=sharing", 
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
