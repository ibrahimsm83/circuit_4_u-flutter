...
class eighty811 extends StatelessWidget {
            ...
            Row(
              children: <Widget>[
                RaisedButton(
                  ...
                  if (status.isGranted){
                    final externalDir=await getExternalStorageDirectory();
                   await FlutterDownloader.enqueue(url: "https://drive.google.com/file/d/1AFvTqac0Z_wWSm4s1uQYWEJL8_6DEYvQ/view?usp=sharing", 
                    savedDir: externalDir.path,
                    fileName: "downloade",
                    showNotification: true,
                    openFileFromNotification: true,
